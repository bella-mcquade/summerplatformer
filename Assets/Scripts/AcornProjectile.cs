...
public class AcornProjectile : MonoBehaviour
{
    ...
    //Creates a fireball and sets the direction to the given direction.
    public void setDirection(float dir)
    {
        direction = dir;
        hit = false;
        boxCol.enabled = true;
        gameObject.SetActive(true); //I assume this makes it so when you click it summons an active object.
